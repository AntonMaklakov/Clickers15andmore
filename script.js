...
'Привет,пользователь!',
'Добрый день,пользователь!'//Массив приветствий
];
//Helvetica Georgia
var randomNum=Math.floor(Math.random()*3);
alert(massiveText[randomNum]);//Приветствие вначале кликера!
...
if(sessionStorage.getItem('textClickPerMinute')!=null){
	...
	var txtContentClickPerMinute="";//Елси инфы про апгрейды нет
}
...
buttonId.addEventListener('click',function(){
	counter=counter+upgrade0;//Самое главное событие,реализация самого кликера
	if(bonusSwitch){
